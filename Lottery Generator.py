...
label = Label(frame1, textvariable=var, font=("Arial", 48),
              width=24, bd=0, highlightthickness=0)
label.pack(side=TOP)
...
txtDisplay = Entry(frame2, textvariable=num1, bd=20, insertwidth=1, font=(
    "Arial", 20), justify='center', width=4, highlightthickness=0, bg="black", fg="white")
txtDisplay.pack(side=LEFT)
txtDisplay = Entry(frame2, textvariable=num2, bd=20, insertwidth=1, font=(
    "Arial", 20), justify='center', width=4, highlightthickness=0, bg="black", fg="white")
txtDisplay.pack(side=LEFT)
txtDisplay = Entry(frame2, textvariable=num3, bd=20, insertwidth=1, font=(
    "Arial", 20), justify='center', width=4, highlightthickness=0, bg="black", fg="white")
txtDisplay.pack(side=LEFT)
txtDisplay = Entry(frame2, textvariable=num4, bd=20, insertwidth=1, font=(
    "Arial", 20), justify='center', width=4, highlightthickness=0, bg="black", fg="white")
txtDisplay.pack(side=LEFT)
txtDisplay = Entry(frame2, textvariable=num5, bd=20, insertwidth=1, font=(
    "Arial", 20), justify='center', width=4, highlightthickness=0, bg="black", fg="white")
txtDisplay.pack(side=LEFT)
txtDisplay = Entry(frame2, textvariable=num6, bd=20, insertwidth=1, font=(
    "Arial", 20), justify='center', width=4, highlightthickness=0, bg="black", fg="white")
txtDisplay.pack(side=LEFT)
...
button1 = Button(frame3, padx=8, width=18, relief="flat", fg="red", bg="black",
                 borderwidth=0, font=("Arial", 26), text="Generator", command=Lotto_No)
